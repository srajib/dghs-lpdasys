...
$result = mysql_query("SELECT lpda.id,lpda.laptop_org_code,lpda.laptop_usc_name,lpda.laptop_electricity_source_value,u.union_name,lpda.laptop_ward_no,lpda.laptop_contact_person,lpda.laptop_contact_person_mobile,lpda.laptop_imei_no,lpda.laptop_sim_no,laptop_serial_no FROM lpda_laptop_usc AS lpda INNER JOIN lpda_union AS u ON u.union_bbs_code = lpda.laptop_union_name WHERE lpda.laptop_upazila_id=u.old_upazila_id AND lpda.id='$id'");
...
if (!$result) 
		...
		$laptop_usc_name=$test['laptop_usc_name'] ;
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span9">
                                <div class="row-fluid">
										...
										<td colspan="2">
										<input type="text" readonly value="<?php echo $laptop_org_code;?>" name="laptop_org_code">
										</td>
										</tr>
										<tr>
										<td>
										...
										<td colspan="2">
										<input type="text" readonly value="<?php echo $laptop_usc_name;?>" name="laptop_usc_name">
										</td>
										</tr>
										<tr>
										<td>
										...
										<td>
										<input name="laptop_contact_person" readonly type="text" class="validate[required]" value="<?php echo $laptop_contact_person;?>">
										</td>
										<td>
										...
										<tr>
										<td>
										<label for="laptop_contact_person_mobile">Contact Person no : </label>
										</td>
										<td>
										<span style="padding-top:2px;">+88</span><input name="laptop_contact_person_mobile" readonly id="laptop_contact_person_mobile" class="validate[required,custom[phone]]" value="<?php echo $laptop_contact_person_mobile;?>">
									    </td>
										<td>
...
{	
	...
	$laptop_contact_person_mobile= $_POST['laptop_contact_person_mobile'] ;
	//$id=$_POST['id'] ;
	
	mysql_query("UPDATE lpda_laptop_usc SET laptop_imei_no='$laptop_imei_no',laptop_sim_no='$laptop_sim_no',laptop_serial_no='$laptop_serial_no' WHERE id='$id'")
	or die(mysql_error()); 
    print "<script>";
