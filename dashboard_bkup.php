                    ...
                    <div class="header-right">
                        ...
                        <div class="user-panel header-divider">
                            <div class="user-info">
                                ...
                                <a href="#">Admin user ( <?php echo $user_email=$_SESSION['email']; ?>)</a>
                            </div>
            ...
            <div class="sidebar">
                ...
                <div class="nav-collapse collapse leftmenu">
                    ...
                    <ul>
                        ...
                        <li><a class="tables" href="laptopinfo.php" title="Tables"><span>Laptop Info</span></a>
                        </li>
                        <li><a class="elements" href="allcc.php" title="Typography"><span>Community Clinic </span></a></li>
