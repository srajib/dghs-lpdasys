                            ...
                            <div class="span9">
                                <div class="row-fluid">
										...
										<select name="laptop_org_code" id="laptop_org_code">
										   <?php
                         $upazila_row = mysql_query("SELECT lpda_organization.org_code,lpda_organization.organization_id
FROM lpda_organization WHERE lpda_organization.org_type_code='1039' AND upazila_id='".$upazila_id."' ORDER BY lpda_organization.org_code ASC ");
   ...
   while ($rows = mysql_fetch_assoc($upazila_row)) {
	    echo "<option value=\"" . $rows['org_code'] . "\">" . $rows['org_code'] . "</option>";
										...
										<td>
										 ...
										 <a href="addcc.php">If not found any cc, please click here. </a>
										</td>
										</tr>
										<tr>
										<td>
										...
										<td>
										<input name="laptop_union_name" type="text">
										</td>
										</tr>
										<tr>
										<td>
										...
										<td>
										<input name="laptop_ward_no" type="text">
										</td>
										</tr>
										<tr>
										<td>
										...
										<td>
										<input name="laptop_chcp_mobile_no" type="text">
									    </td>
										</tr>
										<tr>
										<td>
										...
										<td>
										<input name="laptop_imei_no" type="text">
										</td>
										</tr>
										...
										<td>
										<input name="laptop_sim_no" type="text"><br>
										</td>
										</tr>
										<tr>
										<td>
										...
										<td>
										<input name="laptop_serial_no" type="text">
										</td>
										</tr>
										<tr>
										<td colspan="2">
