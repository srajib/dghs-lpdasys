    	...
    	<div id="headlogo">
            ...
            <table align="center">
             <tbody>
              <tr>
               <td align="center">
                  <span style="float:left;"><img src="./publish_files/gov.jpg" height="50px" alt="BD GOV"></span><span class="subheading" style="font-size: 18px">Laptop distribution list of all CC under Upazila Health Complex <?php //echo $pdfdata->lhb_year; ?></span><br>
		 ...
		 <table class="table table-bordered">
		                                       <tbody>
											     <tr>
													...
													$pdainfo=mysql_query("SELECT * FROM lpda_laptop WHERE id=$ccid");
													$i=1;
