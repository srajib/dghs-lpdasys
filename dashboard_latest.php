                                    ...
                                    <div class="span12">
                                        ...
                                        <section class="utopia-widget">
                                            ...
                                            <div class="utopia-widget-content">
												<b>Name of the Upazila :</b> <?php echo $org_detail['title'];?>  <br/>
                                                <b>Union/Ward :</b>  <input type="text" name="union"><br/>
												<b>Organization Code:  <input type="text" name="org_code"></b> <br/>
                                                <b>Community Clinic: <input type="text" name="org_name"></b> <br/>
