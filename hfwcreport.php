    	...
    	<div id="headlogo">
            ...
            <table align="center">
             <tbody>
              <tr>
               <td align="center">
                  <span style="float:left;"><img src="./publish_files/gov.jpg" height="50px" alt="BD GOV"></span><span class="subheading" style="font-size: 18px">Laptop Requisition for UH&FWC <? //echo $pdfdata->lhb_year; ?></span><br>
    ...
    <div class="fullpage" style="height:4480px;">
     ...
     <tr>
                                                        ...
                                                        <td id="tblclm2">Org code</td>
														 <td id="tblclm2" nowrap="nowrap">Name of USC</td>
														<td id="tblclm2" nowrap="nowrap">Union</td>
                                                        <td id="tblclm2" nowrap="nowrap">New Ward no</td>
														 <td id="tblclm2" nowrap="nowrap">Contact Person Name</td>
														 <td id="tblclm2" nowrap="nowrap">Contact Person Mobile No.</td>
